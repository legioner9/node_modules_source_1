...
// simple hello
    ...
    const f_help = () => {
        write ( `createTechDir_4 with arr = createArrLikeGit_2_v_2` );
    };
    ...
    [r]un createTechDir_4 with arr = createArrLikeGit_2_v_2
    `;
...
QMR_1_d1.mode = { deb: false, log: false, logFs: false , stack: false};
