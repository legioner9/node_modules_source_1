...
const func_atOut_test = require ( '../index' );
debugger

// func_v_1_test_1 fore example
...
atOut_1.test.logFs (func_atOut_test);
func_atOut_test.mode ={ deb: false, log: false, logFs: true, stack: false };
debugger
func_atOut_test()
debugger;
