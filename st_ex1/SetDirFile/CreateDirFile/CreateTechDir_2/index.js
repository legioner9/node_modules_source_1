 ...
 * @param create_arr
 */
const CreateTechDir_2 = ( parent_path, create_arr ) => {
    const dev = CreateTechDir_2.mode === 'debug' || global.mode === 'debug';
    create_arr.forEach ( ( item, index, arr ) => {
        ...
        item.shift ();
        if ( dev ) debugger;
        CreateTechDir_2 ( parent_path_deep, item, dev );
...
CreateTechDir_2.help = `ModuleFunc = () => {}`;

CreateTechDir_2.call = () => console.log ( CreateTechDir_2 );

CreateTechDir_2.mode = 'production';

module.exports = CreateTechDir_2;
