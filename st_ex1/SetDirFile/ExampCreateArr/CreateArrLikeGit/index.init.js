...
const CreateArrLikeGit = [Containers,Content,Src]
...
CreateArrLikeGit.help = `ModuleFunc = () => {}`;

CreateArrLikeGit.call = () => console.log ( CreateArrLikeGit );

CreateArrLikeGit.mode = 'production';

module.exports = CreateArrLikeGit;
