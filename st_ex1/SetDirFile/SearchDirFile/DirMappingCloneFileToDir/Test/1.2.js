...
const cloneFileToDir = require ( 'st_ini' ).cloneFileToDir;

const Fs = require ( 'fs' );
const Path = require ( 'path' );

// const r_f = Ex.SetDirFile.SearchDirFile.DirMappingCloneFileToDir;
cloneFileToDir.mode = 'production';
cloneFileToDir ( __dirname );
